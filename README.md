...
*   **Этап 4 (Рефлексия): Механизм "Адвоката Дьявола".** После каждой фазы Стратег обязан создать задачу для `Contrarian_Expert`, цель которого — найти источники, **опровергающие** самые сильные утверждения, собранные на данном этапе. Это активная борьба с предвзятостью подтверждения.
